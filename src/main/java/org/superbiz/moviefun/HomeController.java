...
public class HomeController {
    ...
    public String setup(Map<String, Object> model) {
        ...
        TransactionStatus transactionStatus = platformTransactionManagerMovies.getTransaction(null);
        ...
        transactionStatus = platformTransactionManagerAlbums.getTransaction(null);
